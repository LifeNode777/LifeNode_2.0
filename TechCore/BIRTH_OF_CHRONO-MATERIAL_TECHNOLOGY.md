...
![Time as a raw material — the birth of chrono-material technology](../img/BIRTH_OF_CHRONO-MATERIAL_TECHNOLOGY.png)
...
![The X-Axis — all engineering in the shadow of the clock](../img/the_X-Axis.png)
...
![The ADC altar — every sample is a small death of the trajectory](../img/information_has_mass_ignorance_has_cost.png)
...
![The wave computes by itself](../img/wave_computes_by_itself.png)
...
![Timescape — whose time is it?](../img/Timescape-whose_time_is_it.png)
...
![Time as a synthetic dimension](../img/time_as_synthetic_dimension.png)
...
![UNIT 02 — do not optimize, listen](../img/do_not_optimize_LISTEN.png)
...
![Quantum vs chrono-material](../img/quantum_vs_chrono.png)
...
![The Bill of Materials of Time](../img/BILL_of_materials_of_time.png)
